...
//{"pwm_config_set_clkdiv", 2 | (1 << 5) | (0b01 << 10), pwm_defines, pwm_config_set_clkdiv, 0, 0, 0},
    ...
    {"acosf", 1 | (1 << 5) | (1 << 10), math_defines, __wrap_acosf, 1, 0, 0},
    {"acoshf", 1 | (1 << 5) | (1 << 10), math_defines, __wrap_acoshf, 1, 0, 0},
    ...
    {"asinf", 1 | (1 << 5) | (1 << 10), math_defines, __wrap_asinf, 1, 0, 0},
    {"asinhf", 1 | (1 << 5) | (1 << 10), math_defines, __wrap_asinhf, 1, 0, 0},
    ...
    {"lcd_clear", 1, spi_defines, lcd_clear, 0, 0, 0},
    {"lcd_draw_circle", 3, spi_defines, lcd_draw_circle, 0, 0, 0},
    {"lcd_draw_image", 3, spi_defines, lcd_draw_image, 0, 0, 0},
    {"lcd_draw_line", 3, spi_defines, lcd_draw_line, 0, 0, 0},
    {"lcd_draw_point", 3, spi_defines, lcd_draw_point, 0, 0, 0},
    {"lcd_draw_point_big", 3, spi_defines, lcd_draw_point_big, 0, 0, 0},
    {"lcd_draw_rectangle", 3, spi_defines, lcd_draw_rectangle, 0, 0, 0},
    {"lcd_init", 0, spi_defines, lcd_init, 0, 0, 0},
    {"lcd_set_rotation", 1, spi_defines, lcd_set_rotation, 0, 0, 0},
    {"lcd_show_char", 3, spi_defines, lcd_show_char, 0, 0, 0},
    {"lcd_show_num", 3, spi_defines, lcd_show_num, 0, 0, 0},
    {"lcd_show_str", 3, spi_defines, lcd_show_str, 0, 0, 0},
    {"lcd_xy_2P", 2, spi_defines, lcd_xy_2P, 0, 0, 0},
    ...
    {"probe_main", 0, stdio_defines, probe_main, 0, 0, 0},
    ...
    {"sinhf", 1 | (1 << 5) | (1 << 10), math_defines, __wrap_sinhf, 1, 0, 0},
    ...
    {"spi_lcd_test", 0, spi_defines, lcd_test, 0, 0, 0},
